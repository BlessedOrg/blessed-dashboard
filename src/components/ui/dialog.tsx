...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-1.5 text-center sm:text-left font-ttBluescreens", className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("text-5xl font-bold leading-none tracking-tight", className)}
    {...props}
  />
));
