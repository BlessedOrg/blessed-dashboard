...
export const Navigation = ({ appId, eventId }: NavigationProps) => {
  ...
  return (
    <nav className={`grid grid-cols-2 ${settings.showMiddleNavigation && settings.middleNavigationItems  ? "md:grid-cols-3" : "md:grid-cols-2"} w-full py-6 px-6 sticky top-0 left-0 right-0 z-20 bg-root-background`}>
