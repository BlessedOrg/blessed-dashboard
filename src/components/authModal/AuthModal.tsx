...
export const AuthModal = ({ isOpen }: { isOpen: boolean }) => {
  ...
  const [type, setType] = useState<"login" | "onboarding">("login");
    ...
    >
      ...
      >
        ...
        {!emailSent && (
          <div className="flex flex-col gap-4">
            ...
            <Card className="bg-yellow-500 !p-5">
              <span>
                <span className="font-semibold">We’ll send you a quick verification code</span>, so keep an eye on your inbox.
              </span>
            </Card>
          </div>
        )}
        {emailSent && (
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="w-full flex justify-center">
              <InputOTP maxLength={6} pattern={REGEXP_ONLY_DIGITS} onChange={(value) => setCode(value)} disabled={isLoading}>
                <InputOTPGroup>
        ...
        <DialogFooter className="flex !flex-col gap-2 items-center !justify-center">
          <div>
            {!emailSent && (
              <Button onClick={onEmailSubmit} isLoading={isLoading} variant="green" size="xl" className="rounded-full px-8 min-w-[180px]">
          ...
          {emailSent && (
            <div className="flex flex-col gap-2">
              <div className="flex gap-2 items-center mt-4">
                ...
                <button className="text-sm underline tabular-nums" onClick={handleResendCode} disabled={resendTimer > 0 || isLoading}>
