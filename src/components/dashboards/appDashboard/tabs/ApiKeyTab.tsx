...
import { createApiToken } from "@/app/api/applications";
      ...
      <Card className="w-full">
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col gap-4">
            ...
            <Card className="!bg-yellow-500 p-4" variant="rounded">
          ...
          <div className="flex gap-4 items-center">
            <Button onClick={onGenerateNewApiKey} variant="outline" isLoading={isGeneratingApiKey} className="w-fit">
              Create new token
            </Button>
            {!!generatedApiToken && (
          ...
          {!!generatedApiToken && (
            <div className="flex flex-col gap-4">
              <p>
                ...
                <a
                  href={`${apiDogsDocsUrl}?environment[apiKey]=${generatedApiToken}&environment[app]=${appId}`}
                  target="_blank"
