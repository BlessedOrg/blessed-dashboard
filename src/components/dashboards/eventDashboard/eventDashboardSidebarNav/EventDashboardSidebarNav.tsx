...
import { eventSidebarNavItems } from "@/components/dashboards/eventDashboard/eventDashboardSidebarNav/eventSidebarNavItems";

export const EventDashboardSidebarNav = ({ currentTabIndex, className }: { currentTabIndex: number; className?: string }) => {
  return (
